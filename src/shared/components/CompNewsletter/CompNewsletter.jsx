                  ...
                  {item.attributes &&
                    ...
                    item.attributes.posterImage.original && (
                      <img
                        ...
                        className="c-compnewsletter__img"
                      />
                    )}
                  {item.attributes && item.attributes.canonicalTitle && (
                    <h3 className="c-compnewsletter__title">
                      {item.attributes.canonicalTitle}
                    </h3>
                  )}
                  {item.attributes && item.attributes.updatedAt && (
                    <p className="c-compnewsletter__date">
                      {item.attributes.updatedAt}
                    </p>
                  )}
                  {item.attributes && item.attributes.synopsis && (
                    <p className="c-compnewsletter__desc">
