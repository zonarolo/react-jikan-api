        ...
        {props.jikans.map((item,index)=>
          <div className={index < 3 ? "col-lg-4 col-sm-6 ": "col-lg-3 col-md-4"} key={index}>
            <figure className="c-jikanGallery__item" >
              {item && item.attributes && item.attributes.posterImage && <img className={ index < 3 ? "c-jikanGallery__img c-jikanGallery__img--max":"c-jikanGallery__img"} src={item.attributes.posterImage.original}/>}
